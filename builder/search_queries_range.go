...
// Gt indicates a greater-than value for the gt part.
...
// Gte indicates a greater-than-or-equal value for the gte part.
...
// Lt indicates a less-than value for the lt part.
// Use nil lt indicate an unbounded lt part.
func (q *RangeQuery) Lt(lt interface{}) *RangeQuery {
	q.lt = lt
	return q
}

// Lte indicates a less-than-or-equal value for the lte part.
// Use nil lte indicate an unbounded lte part.
